                ...
                <div className="max-width grid  grid-cols-1 gap-5 md:grid-cols-3 lg:grid-cols-5">
                    ...
                    <article>
                        ...
                        <ul>
                            ...
                            <li><button className="text-slate-200 text-sm mt-1">Career</button></li>
                            <li><button className="text-slate-200 text-sm mt-1">Contact</button></li>
                        </ul>
                    </article>
                    <article>
                        <ul className='flex items-center'>
                            <li className="ml-4"><img src={facebook} alt="" /></li>
                            <li className="mx-4"><img src={twitter} alt="" /></li>
                            <li className="mx-4"><img src={pinterest} alt="" /></li>
                            <li className="mx-4"><img src={instagram} alt="" /></li>
                        </ul>
                    </article>
                </div>
            </footer>
